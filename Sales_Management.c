...

{
    ...
    //printf("Enter name of stock that you want to sell: ");
   // scanf("%s",name);
    ...
    while(!feof(fp))
    {
        ...
        {
            fl = 1;
         //   printf("Price of stock of %s is: %d\n",buf,price);
         ...
         //   scanf("%d",&temp);
           ...
           // printf("Price of share(=%d) * No. of shares(=%d) = Total amount to be collected(=%d)\n",price,temp,price*temp);
